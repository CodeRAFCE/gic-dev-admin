...
import {
	SubscribeTableRow,
	SubscribeTableToolbar,
} from "../../../sections/@dashboard/subscribers/list";

//redux
import {useDispatch, useSelector} from "src/redux/store";
import {getSubscribers} from "src/redux/slices/subscribers/subscriberSlice";
...
const TABLE_HEAD = [
	...
	{id: "isSubscribed", label: "Subscribed", align: "center"},
	{id: ""},
];
...
export default function SubscribersList() {
	...
	const {subscribers, isSubscriberLoading} = useSelector((state) => state.subscriber);
	...
	const isNotFound =
		...
		(!isSubscriberLoading && !dataFiltered?.length);

	return (
		<Page title="Subscribers: List">
			<Container maxWidth={themeStretch ? false : "lg"}>
				<HeaderBreadcrumbs
					heading="Subscribers List"
					links={[
						{name: "Dashboard", href: PATH_DASHBOARD.root},
						{name: "Subscribers", href: PATH_DASHBOARD.subscriber.root},
						{name: "List"},
					]}
					// action={
					// 	<Button
