...
import {getCustomers, removeCustomers} from 'src/redux/slices/customer/customerSlice';
...
export default function UserList() {
	...
	const {customers, isCustomerLoading} = useSelector((state) => state.customer);
	...
	const isNotFound =
		...
		(!isCustomerLoading && !dataFiltered?.length);
			...
			<Container maxWidth={themeStretch ? false : 'lg'}>
				...
				<Card>
					<UserTableToolbar
						...
						onFilterRole={handleFilterEmail}
					/>
